...
function InputThumbnail({ title, thumbname, thumbvalue, onChange, value }) {
  const [file, setFile] = useState(null);
  const [fileDataURL, setFileDataURL] = useState(null);

  //calling the global state to store image uploaded value
    ...
    return (
      <>
        <div className="thumbnail">
          <img src={fileDataURL} defaultValue={value} />
